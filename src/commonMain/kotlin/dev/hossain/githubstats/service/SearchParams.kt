...
import dev.hossain.platform.urlEncode
import kotlin.text.Charsets // UTF_8 is part of top-level Charsets in common
...
class SearchParams constructor(
    ...
    fun toQuery(): String {
        ...
        query
            ...
            .append(urlEncode("is:pr"))
            .append("+")
            // https://docs.github.com/en/search-github/searching-on-github/searching-issues-and-pull-requests#search-based-on-whether-a-pull-request-is-merged-or-unmerged
            .append(urlEncode("is:merged"))
            .append("+")
            ...
            .append(urlEncode("repo:$repoOwner/$repoId"))
            .append("+")
        ...
        if (reviewer != null) {
            query
                ...
                .append(urlEncode("reviewed-by:$reviewer"))
        }
