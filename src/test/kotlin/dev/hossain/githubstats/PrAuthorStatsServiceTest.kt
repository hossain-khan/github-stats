...
class PrAuthorStatsServiceTest {
    ...
    @Test
    fun `authorStats - successfully aggregates stats for an author with multiple PRs`() = runTest {
        val authorId = "author"
    ...
    @Test
    fun `authorStats - handles partial failures when fetching some PR stats`() = runTest {
        val authorId = "author"
        val pr1 = createIssue(1, authorId)
        val pr2 = createIssue(2, authorId)
    ...
    @Test
    fun `authorStats - throws exception when error threshold is exceeded`() = runTest {
        val authorId = "author"
