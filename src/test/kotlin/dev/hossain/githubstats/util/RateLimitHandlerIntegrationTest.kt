...
class RateLimitHandlerIntegrationTest {
    @Test
    fun `executeWithRateLimit - given successful API call - returns result without retry`() =
        runTest {
    ...
    fun `isRateLimitError - correctly identifies rate limit errors`() {
        ...
        val rateLimitError =
            GithubError(
                message =
                    "API rate limit exceeded for user ID 99822. If you reach out to GitHub Support for help, " +
                        "please include the request ID CF05:4DFD1:19AA6E5:33F8C4B:687A2E8E and timestamp 2025-07-18 11:22:54 UTC.",
                documentationUrl = "https://docs.github.com/rest/overview/rate-limits-for-the-rest-api",
                status = 403,
            )
        val rateLimitErrorInfo =
            ErrorInfo(
