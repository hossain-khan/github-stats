...
class PrReviewerStatsServiceTest {
    ...
    @Test
    fun `reviewerStats - successfully aggregates stats for a reviewer`() =
        runTest {
    ...
    @Test
    fun `reviewerStats - correctly filters PRs where the reviewer actually provided approval`() =
        runTest {
            val reviewerId = "reviewer"
            val authorId = "author"
            val pr1 = createIssue(1, authorId)
    ...
    @Test
    fun `reviewerStats - handles empty results`() =
        runTest {
            val reviewerId = "reviewer"
