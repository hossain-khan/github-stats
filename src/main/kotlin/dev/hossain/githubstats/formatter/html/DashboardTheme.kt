...
/**
 * Shared modern design tokens, CSS styles, icons, and theme scripts for all HTML reports.
 * Implements a modern SaaS / Analytics Admin Panel aesthetic with dark/light mode support.
 */
object DashboardTheme {
    /**
     * Common HTML `<head>` assets: Bootstrap 5, Bootstrap Icons, Google Fonts (Inter), and Chart.js.
     */
    fun headAssets(title: String): String =
        """
        <meta charset="UTF-8">
    ...
    fun customCss(): String =
        ...
        [data-bs-theme="dark"] {
            ...
            --text-body: #cbd5e1;
            --text-muted: #94a3b8;
            --table-hover-bg: #1a233a;
            --header-bg: rgba(19, 27, 46, 0.85);
        ...
        .kpi-icon-rose { background: rgba(244, 63, 94, 0.15); color: #f43f5e; }
    ...
    /**
     * Shared JavaScript logic for theme toggling, Chart.js global theme integration, and table search filtering.
     */
    fun sharedScripts(): String =
        """
        <!-- Bootstrap 5 JS -->
        ...
        <script>
            ...
            // -------------------------------------------------------------
            // Chart.js Theme Defaults & Responsive Adapter
            // -------------------------------------------------------------
